...
function! s:HighlightExtraTypes() abort
  return get(g:, 'go_highlight_extra_types', 1)
endfunction
...
function! s:HighlightOperators() abort
  return get(g:, 'go_highlight_operators', 1)
endfunction

function! s:HighlightFunctions() abort
  return get(g:, 'go_highlight_functions', 1)
endfunction

function! s:HighlightFunctionParameters() abort
  return get(g:, 'go_highlight_function_parameters', 1)
endfunction

function! s:HighlightFunctionCalls() abort
  return get(g:, 'go_highlight_function_calls', 1)
endfunction

function! s:HighlightFields() abort
  return get(g:, 'go_highlight_fields', 1)
endfunction

function! s:HighlightTypes() abort
  return get(g:, 'go_highlight_types', 1)
endfunction
...
function! s:HighlightStringSpellcheck() abort
  return get(g:, 'go_highlight_string_spellcheck', 0)
endfunction

function! s:HighlightFormatStrings() abort
  return get(g:, 'go_highlight_format_strings', 0)
endfunction

function! s:HighlightGenerateTags() abort
  return get(g:, 'go_highlight_generate_tags', 1)
endfunction

function! s:HighlightVariableAssignments() abort
  return get(g:, 'go_highlight_variable_assignments', 1)
endfunction

function! s:HighlightVariableDeclarations() abort
  return get(g:, 'go_highlight_variable_declarations', 1)
endfunction
