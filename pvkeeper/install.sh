...
echo "start install code_common plugin"
git clone https://github.com/dense-analysis/ale.git ~/.vim/pack/code_common/opt/ale
...
#code_common_path = ~/.vim/pack/golang/opt
echo "mkdir -p ~/.vim/pack/golang/opt"
mkdir -p ~/.vim/pack/golang/opt

echo "start install vim-go"
git clone https://github.com/fatih/vim-go.git ~/.vim/pack/golang/opt/vim-go
