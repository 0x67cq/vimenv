...
"syn keyword cType char enum float int long short double void union 
"syn keyword cStatement break case continue default do else for goto if return switch while
"syn keyword cStruct auto const extern register signed static struct typedef unsigned volatile
"syn keyword cBuildIn sizeof

"hi link cType Type
"hi link cStruct Keyword
"hi link cBuildIn Identifier
...
"syntax match cStatement " .*(" 
"syntax match cStatement ")" 

"hi link cStatement Statement

"syntax match cParam "(.*)"
"hi link  cParam Identifier
"
" Vim syntax file
" Language:	C
